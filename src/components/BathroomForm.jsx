...
export default function BathroomForm({ profile, bathrooms, setBathrooms, GMKey, supabase }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            // need to change this line for Supabase DB access
            // const bathroomResp = await fetch('/bathrooms', bathroomConfig)

            // new line for Supabase
            const bathroomResult = await supabase.from('bathrooms').insert(bathroomSupabase).select()
            ...
            const reviewConfig = {
                ...
                body: JSON.stringify({
                    user_id: profile.id,
                    bathroom_id: createdBathroom.id,
            ...
            // new line for Supabase
            const reviewResult = await supabase.from('reviews').insert(reviewSupabase).select()
            ...
            <form id='new-bathroom-form' onSubmit={handleSubmit}>
                <section id='bathroom-fields'>
                    <div>
                        ...
                        <input id='nb-location-name' name='location-name' type='text' value={locationName} onChange={(e) => setLocationName(e.target.value)}></input>
                    </div>
                    <div>
                        <label htmlFor="nb-address">Street Address:</label>
                        <input id='nb-address' name='address' type='text' value={address}
                            onChange={(e) => setAddress(e.target.value)}></input>
                    </div>
                    <div>
                        <label htmlFor="date-picker">Date visited:</label>
                        <DatePicker id='date-picker' name='date' selected={date}
                            onChange={(date) => setDate(date)} />
                    </div>
                    <div>
                        <label htmlFor="nb-location-description">Location description:</label>
                        <textarea id='nb-location-description' name='location-description' type='text' value={bathroomDescription} onChange={(e) => setBathroomDescription(e.target.value)}></textarea>
                    </div>
                    <div>
                        <label htmlFor="nb-public-bool">Public?</label>
                        <div id='nb-public-bool'>
                            <input className="nb-public-radio" name='public-radio-true' type='radio' value={true} onChange={(e) => setPublicBool(e.target.value === 'true')}></input>
                            <label>True</label>
                            <input className="nb-public-radio" name='public-radio-false' type='radio' value={false} onChange={(e) => setPublicBool(e.target.value === 'true')}></input>
                            <label>False</label>
                        </div>
                    </div>
                </section>
                <section id='review-fields'>
                    <div>
                        <label htmlFor="nr-bathroom-description">Bathroom description:</label>
                        <textarea id='nr-bathroom-description' name='bathroom-description' type='' value={reviewDescription} onChange={(e) => setReviewDescription(e.target.value)} />
                    </div>
                    <div>
                        <label htmlFor="nr-cleanliness">Cleanliness:</label>
                        <textarea id='nr-cleanliness' type='text' value={cleanliness} onChange={(e) => setCleanliness(e.target.value)} />
                    </div>
                    <div>
                        <label htmlFor="nr-cleanliness-rating">Cleanliness rating:</label>
                        <RatingButton rating={cleanlinessRating} setRating={setCleanlinessRating} />
                    </div>
                    <div>
                        <label htmlFor="nr-function">Function:</label>
                        <textarea id='nr-function' type='text' value={bathroomFunction} onChange={(e) => setBathroomFunction(e.target.value)} />
                    </div>
                    <div>
                        <label htmlFor="nr-function-rating">Function rating:</label>
                        <RatingButton rating={bathroomFunctionRating} setRating={setBathroomFunctionRating} />
                    </div>
                    <div>
                        <label htmlFor="nr-style">Style:</label>
                        <textarea id='nr-style' type='text' value={style} onChange={(e) => setStyle(e.target.value)} />
                    </div>
                    <div>
